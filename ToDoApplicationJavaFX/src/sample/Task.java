...
public class Task implements Comparable<Task>
{
    ...
    private String levelOfImportance; // High, Medium, Low
    ...
    public void setPriorityLevel(boolean timeSensitive, String levelOfImportance)
    {
        // Low to High
        // ts false && LOI low          1
        if(timeSensitive == false && levelOfImportance.equals("Low")){priorityLevel = 1;}
        // ts false && LOI medium       2
        else if(timeSensitive == false && levelOfImportance.equals("Medium")){priorityLevel = 2;}
        // ts false && LOI high         3
        else if(timeSensitive == false && levelOfImportance.equals("High")){priorityLevel = 3;}
        // ts true && LOI low           4
        else if(timeSensitive == true && levelOfImportance.equals("Low")){priorityLevel = 4;}
        // ts true && LOI medium        5
        else if(timeSensitive == true && levelOfImportance.equals("Medium")){priorityLevel = 5;}
        // ts true && LOI high          6
        else if(timeSensitive == true && levelOfImportance.equals("High")){priorityLevel = 6;}
